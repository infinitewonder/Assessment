...
public class PizzaOrder {
    ...
    public void setTopplings(List<String> toppings) {
        this.toppings = toppings;
    }

    public List<String> getTopplings() {
    ...
    // WARNING: DO NOT MODIFY THIS FILE. 2 MARKS WILL BE DEDUCTED FOR EVERY MODIFIED
    // LINE
}
